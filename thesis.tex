...
E' stato un percorso lungo ed inaspettato. Nell'ultimo periodo è stato anche faticoso, ma nulla si raggiunge senza sacrifici. In primis ringrazio i ragazzi con il quale ho condiviso questo percorso partito nel settembre del 2016. Ragazzi che, con la loro spensieratezza, mi hanno dato una visione diversa della vita. Ringrazio questo percorso perchè ho incontrato un amico, Jack, con cui abbiamo affrontato i momenti belli e quelli un pò meno insieme e che, alla fine di tutto ciò so che ci sarà sempre come lui sa che ci sarò. Ringrazio i prof. , i quali chi in un modo e chi nell'altro hanno trasmesso la loro voglia di insegnare. Un ringraziamento leggermente diverso, con le dovute scuse, al prof. Giovanni Lagorio, che mi ha supportato e sopportato in quest'ultimo percorso in quanto è stato più difficoltoso del previsto.
Ringrazio i miei genitore che, nonostante i 700 km di distanza, sono stati e sono presenti. Infine ringrazio Valeria, mia moglie, per tutti i sacrifici che fa per darmi lo spazio di seguire i miei obiettivi. La ringrazio ancora di più perchè nel percorso di laurea mi ha regalato due splendidi bimbi, Aurora e Damiano. Ringrazio loro per esserci e per le emozioni che ogni giorno mi danno. 
