...
We start our research about \emph{kernel exploitation} with this goal: explaining what the kernel is and what exploitation means.
...
The options parameter is used to specify which state change the \texttt{waitid} system call should wait.
